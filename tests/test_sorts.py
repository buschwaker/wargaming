...
class TestSorts(unittest.TestCase):
    ...
    def test_quick_sort(self):
        ...
        self.assertEqual(
            call_random, self.result_random_list, 'Функция quick_sort() не работает со списком случайных значений'
        )
        self.assertEqual(
            call_sorted_asc, self.result_sorted_asc, 'Функция quick_sort() не работает с сортированным списком'
        )
        self.assertEqual(
            call_sorted_desc, self.result_sorted_desc,
            'Функция quick_sort() не работает со списком случайных значений(от большего к меньшему)'
        )
    ...
    def test_merge_sort(self):
        ...
        self.assertEqual(
            call_random, self.result_random_list, 'Функция merge_sort() не работает со списком случайных значений'
        )
        self.assertEqual(
            call_sorted_asc, self.result_sorted_asc, 'Функция merge_sort() не работает с сортированным списком'
        )
        self.assertEqual(
            call_sorted_desc, self.result_sorted_desc,
            'Функция merge_sort() не работает со списком случайных значений(от большего к меньшему)'
        )
