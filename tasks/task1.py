def if_even_one_intersection(num: int):
...
def if_even_recursive(num: int):
    ...
    Плюсы: Явных плюсов по сравнению с двумя
    предыдущими алгоритмами не замечено
